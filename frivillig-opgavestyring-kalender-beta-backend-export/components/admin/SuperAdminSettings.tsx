...
export const SuperAdminSettings: React.FC = () => {
    const { settings, setSettings, userHasPermission } = useData();
    ...
    const handleSaveSettings = () => {
        ...
        toast.success('Indstillingerne er gemt!');
    };
    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md space-y-6">
            ...
            <>
                ...
                <button onClick={handleSaveSettings} className="w-full bg-emerald-600 text-white p-2 rounded hover:bg-emerald-700">Gem Sideindstillinger</button>
            </>
            ) : (
